...
COPY publishers
FROM '/docker-entrypoint-initdb.d/data/publishers.csv'
DELIMITER ';'
ENCODING 'UTF8'
CSV HEADER;
...
COPY readers
FROM '/docker-entrypoint-initdb.d/data/readers.csv'
DELIMITER ';'
ENCODING 'UTF8'
CSV HEADER;

COPY authors
FROM '/docker-entrypoint-initdb.d/data/authors.csv'
DELIMITER ';'
ENCODING 'UTF8'
CSV HEADER;

COPY books
FROM '/docker-entrypoint-initdb.d/data/books.csv'
DELIMITER ';'
ENCODING 'UTF8'
CSV HEADER;

COPY books_to_authors(fk_book_id, fk_author_id)
FROM '/docker-entrypoint-initdb.d/data/books-to-authors.csv'
DELIMITER ';'
ENCODING 'UTF8'
CSV HEADER;

COPY issues (fk_employee_id, fk_book_id, fk_reader_id, issue_dt, return_dt, returned)
FROM '/docker-entrypoint-initdb.d/data/issues.csv'
DELIMITER ';'
ENCODING 'UTF8'
CSV HEADER;
